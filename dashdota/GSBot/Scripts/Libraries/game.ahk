...
HeroShrine(hero)
{
	...
	hero.MoveItem(Item.BackpackL, Item.UpperL)
	hero.MoveItem(Item.BackpackM, Item.UpperM)
	hero.MoveItem(Item.BackpackR, Item.UpperR)
	hero.MoveItem(Item.LowerL, Item.BackpackL)
	hero.MoveItem(Item.LowerM, Item.BackpackM)
	hero.MoveItem(Item.LowerR, Item.BackpackR)
	hero.MoveItem(Item.BackpackL, Item.LowerL)
	hero.MoveItem(Item.BackpackM, Item.LowerM)
	hero.MoveItem(Item.BackpackR, Item.LowerR)
	MouseMove, xCurPos, yCurPos
	BlockInput, MouseMoveOff
}
